...
import { Box, ThemeProvider, AppBar, Toolbar, Drawer, ListItemButton, ListItemText, Button, Container, Paper, Typography, Collapse, List, ListItemIcon, IconButton, CssBaseline, Divider } from '@mui/material';
        ...
        <AppBar
          ...
          <Toolbar>
            ...
            <Box sx={{ flexGrow: 0 ,display: { xs: 'flex', md: 'none' } }}>
              <LoginIcon variant="contained" onClick={() => navigate("/")}>
              </LoginIcon>
            </Box>
          </Toolbar>
        </AppBar>
